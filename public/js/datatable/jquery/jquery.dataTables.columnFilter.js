...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable, pastOnly, defaultvalues) {
            defaultvalues   = $.extend({from:'', to:''}, defaultvalues);
            var fromValue   = defaultvalues.from;
            var toValue     = defaultvalues.to;
            
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="date_range_filter" id="' + sFromId + '" rel="' + i + '" value="' + fromValue + '" />');
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="date_range_filter" id="' + sToId + '" rel="' + i + '" value="' + toValue + '" />');
            from.datepicker({
...
//            });
            ...
            $('#' + sFromId + ',#' + sToId, th).each(function(){
        ...
        return this.each(function () {
                ...
                if (aoColumn != null) {
                    ...
                    switch (aoColumn.type) {
                        ...
                        case "number-range":
                            ...
                            break;
                        case "date-range":
                            fnCreateDateRangeInput(oTable, aoColumn.pastonly, aoColumn.defaultvalues);
                            break;
                        case "checkbox":
            ...
            if (oTable.fnSettings().oFeatures.bServerSide) {
                ...
                oTable.fnSettings().fnServerData = function (sSource, aoData, fnCallback) {
                    columnsShown = $('#tableau').getColumnsShown(oTable);
