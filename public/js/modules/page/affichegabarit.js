...
//                });
                ...
                $(document.body).on('click', '.301-remove:not(.disabled)', function(e) {
                    ...
                    $this.remove();
                    if ($('.301-remove', $fieldSet301).length == 1) {
                        $('.301-remove', $fieldSet301).addClass('disabled');
                    }
                });
                ...
                $(document.body).on('click', '.js-checkbox', function(e) {
                    if ($(this).is(':checked')) {
                        $(this).next().val(1);
                    } else {
                        $(this).next().val(0);
                ...
                $(document.body).on('click', '.delBloc', function(e) {
                    e.preventDefault();
                ...
                $(document.body).on('click', '.previsu', function(e) {
                    e.preventDefault();
...
//                    });
                    ...
                    $(document.body).on('mouseover', '.mceEditor', function(e) {
                        var id = $(this).attr('id').split('_');
                        var name = id[0];
                        var contentRule = [];
                        var content = '<img style="float:left;" src="public/default/back/img/help.gif" alt="Aide" /><div style="margin-left:35px;margin-top:7px;">';
                    ...
                    $(document.body).on('mouseout', '.mceEditor', function(e) {
                        var id = $(this).attr('id').split('_'),
                                name = id[0],
                                $this = $(this);
