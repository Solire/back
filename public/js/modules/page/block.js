define(
['jquery', 'modules/helper/amd', 'modules/helper/wysiwyg', 'modules/helper/confirm'],
function ($, helperAmd, HelperWysiwyg, helperConfirm) {
  return {
    run: function (wrap, response) {
      var currentModule = this;
      $(wrap).on('click', '.exec-onclick-addblock', function (e) {
        var that, adupliquer, sortBox, clone, wysiwygToInit;
