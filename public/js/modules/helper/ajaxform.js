define(['jquery', 'jqueryControle', 'jqueryScrollTo', 'modules/helper/wysiwyg', 'modules/helper/after'], function ($, jqueryControle, jqueryScrollTo, HelperWysiwyg, HelperAfter) {
  return {
    run: function (wrap, response) {
      ...
      $(wrap).controle({
        ...
        afterSubmit: function (responseFromCallback) {
          HelperAfter.run(wrap, responseFromCallback);
        }
      }, regExps);
    }
  };
