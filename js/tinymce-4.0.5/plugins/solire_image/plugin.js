...
tinymce.PluginManager.add('solire_image', function(editor) {
	function getImageSize(url, callback) {
		var img = document.createElement('img'), style;
	...
	function showDialog(imageList) {
		...
		function buildImageList() {
			var linkImageItems = [{text: 'Choisir une image', value: ''}];
	...
	editor.addMenuItem('solire_image', {
		icon: 'image',
		text: 'Insert image',
		onclick: createImageList(showDialog),
		context: 'insert',
